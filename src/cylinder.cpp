...
void Cylinder::generateVertices()
{
    ...
    // G�n�rer les vertices du pourtour
...
void Cylinder::generateTextureCoordinates()
{
    ...
    // Coordonn�es pour la surface lat�rale
    for (int i = 0; i <= slices; i++) {
    ...
    // Coordonn�es pour les centres (pour les cercles du haut et du bas)
    for (int i = 0; i < slices; i++) {
